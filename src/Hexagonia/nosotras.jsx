...
export default function CardsMujeres() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fff7fb] to-[#fff7fb] flex items-center justify-center p-10 overflow-x-auto">
      <div
        className={`flex flex-nowrap gap-10 transition-all duration-700 ${
      ...
      >
        {mujeres.map((mujer, index) => (
          <div
            key={index}
            className="relative bg-white rounded-2xl shadow-lg w-80 flex-shrink-0 transform transition duration-500 hover:-translate-y-3 hover:shadow-2xl overflow-hidden group"
          >
           +
            <img
              src={mujer.imagen}
