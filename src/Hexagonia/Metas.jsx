...
export default function MetasPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#fff7fb] to-[#fdeef4] flex items-start justify-center py-16 px-6">
          ...
          {metas.map((meta, idx) => (
            <article
              ...
              className={`
                ...
                duration-400 hover:-translate-y-2 hover:shadow-2xl
                flex flex-col gap-4
            ...
            >
              ...
              <div className="mt-3">
                <button
                  className="inline-block px-4 py-2 text-sm font-medium rounded-lg bg-[#B85A76] text-white hover:bg-[#a14a63] transition"
