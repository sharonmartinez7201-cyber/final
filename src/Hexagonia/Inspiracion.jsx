...
const mujeres = [
  ...
  },
  {
    ...
    imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6x4vxIq5AtBP089MV1HiOVfVvD-u7OxZ5ew&s",
    descripcion:
  ...
  {
    nombre: "Frida Kahlo",
    imagen: "https://mott.pe/noticias/wp-content/uploads/2018/09/8-hechos-interesantes-de-la-vida-de-frida-kahlo-que-te-sorprenderan-e1536247529665.jpg",
    descripcion:
  ...
  },
  {
    ...
    imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQ0rUNXRnCH8wPHHjJ6nXi_Zfrf2-P2QaJqg&s",
    descripcion:
      "Matemática de la NASA cuyas ecuaciones fueron vitales para las misiones espaciales de EE.UU.",
  },
];

function CardsMujeres() {
  return (
    <section className="py-1  bg-gradient-to-b from-[#fff7fb] to-[#fff7fb] min-h-screen">
      <h2 className="text-4xl font-serif text-center text-[#B85A76] italic mb-12 drop-shadow-sm">
        MUJERES QUE INSPIRAN EL CAMBIO
      </h2>

      {/* Contenedor que centra las cards */}
